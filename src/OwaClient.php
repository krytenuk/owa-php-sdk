...
class OwaClient
{
    ...
    var array $config = [];
    var ?ResponseInterface $last_response = null;
    ...
    public function getHttpClient($params = []): Client
    {
        return new Client($params);

    }

    public function generateRequestSignature($request, $credentials = []): string
    {
        if (!$credentials) {
    ...
    public static function setDefaultParams($defaults, $params): ?array
    {
    ...
    public function ns($value): array|string|null
    {
